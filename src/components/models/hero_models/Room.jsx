...
Command: npx gltfjsx@6.5.3 nithin.glb 
*/
...
export function Room(props) {
  ...
  const bodyMaterial = materials.avaturn_body_material;
  const hair0Material = materials.avaturn_hair_0_material;
  const hair1Material = materials.avaturn_hair_1_material;
  const lookMaterial = materials.avaturn_look_0_material;
  const shoesMaterial = materials.avaturn_shoes_0_material;
